...
# s3 buckets
target_bucket_name = 'redfin-transformed-s3-buscket-asad'
...
with DAG('asad-redfin_analytics_dag',
        ...
        load_to_s3 = BashOperator(
            ...
            bash_command = 'aws s3 mv {{ ti.xcom_pull("tsk_extract_redfin_data")[0]}} s3://store-raw-data-asad',
        )
